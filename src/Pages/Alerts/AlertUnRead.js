...
const AlertUnRead = (props) => {
    ...
    const getAllList = async () => {
        setDataLoading(true);
        let _list = await getUnReadAlerts(allPageFilters);
    ...
    return (
        <div
            data-test="alert-unread-main-wrapper"
            className={`alert-content-section ${alertsList.length > 0 && 'enable-border'}`} ref={scrollContainer}>
            {
