...
const setup = (defaultProps) => {
    return shallow(<SelectedFeat {...defaultProps} />);
}
...
describe("Header Component",()=>{
    ...
    test('Render Header Component  Without Error',()=>{
        const listed=findByTestAttr(wrapper,'selecetd')
        ...
        let wrapper1=setup({...defaultProps, data_selected:""})
        const listed1=findByTestAttr(wrapper1,'listed')
       expect(listed1.first().simulate('click').length).toBe(1)
    })
