...
const setup = (historyMock,props,paramMock) => {
    ...
    return  mount(<Provider store={store}><Router history={historyMock} id={paramMock}><EditRoles {...props} /></Router></Provider>,{ attachTo: document.getElementById('table-container') });
}
...
describe("EditRole Component", () => {
    ...
    test('render EditRole Popup without error',async()=> {
        ...
        const editRole = await waitFor(()=> findByTestAttr(wrapper,'editRole'))
